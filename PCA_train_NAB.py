...
import random
import json
from PCA_base_dataset import FeatDataLayer, LoadDataset
from PCA_base_models import _netD, _netG,_param, LINEAR_LOGSOFTMAX, weights_init
...
def train():
    ...
    for part in range(parts):
        netGs.append(_netG(dataset.text_dim, 512, 400).cuda().apply(weights_init))
